...
export const tableColumns: BasicColumn[] = [
  {
    title: t('views.warehouse_location.id'),
    dataIndex: 'id',
    fixed: 'left',
    sorter: true,
  },
  {
    title: t('views.warehouse_location.code'),
    dataIndex: 'code',
    fixed: 'left',
  },
  {
    title: t('views.warehouse_location.input_name'),
    dataIndex: 'name',
    fixed: 'left',
  },
  {
    title: t('views.warehouse_location.input_type'),
    dataIndex: 'type_txt',
    fixed: 'left',
  },
  {
    title: t('views.warehouse_location.input_active'),
    dataIndex: 'active',
    fixed: 'left',
    slots: { customRender: 'active_txt' },
  },
  {
    title: t('views.warehouse_location.created_at'),
